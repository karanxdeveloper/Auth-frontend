...
function EmailVerify() {
  ...
  return (
    ...
    <form onSubmit={onSubmitHandler} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
      <h1 className='text-white text-2xl font-semibold text-center mb-4'>Email
        Verify OTP
      </h1>
      ...
      <button
       className='w-full py-3 bg-gradient-to-br rounded-full text-white from-indigo-400 to-indigo-800'>
        Verify Email</button>
    </form>
